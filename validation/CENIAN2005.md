...
[物理模型 v3 代表点重放](results/cenian2005_phelps_v3_replay_minus30_seed20260814/README.md)使用干净提交 `45ead2e` 重算 `-30 V`、种子 20260814。电流和内部标准误与主对比对应行在存储精度下完全相同，说明该代表点可由当前代码精确复现；这不是稳态或收敛证明。
